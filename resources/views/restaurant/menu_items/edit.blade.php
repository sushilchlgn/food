        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 md:p-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('restaurant.menu-items.update', $menuItem->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT') {{-- or PATCH --}}
                        ...
                        <div>
                            ...
                            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name', $menuItem->name)" required autofocus />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" type="number" name="price" :value="old('price', $menuItem->price)" required step="0.01" min="0" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="category" class="block mt-1 w-full" type="text" name="category" :value="old('category', $menuItem->category)" />
                        ...
                        <div class="mt-4">
                            ...
                            <img src="{{ asset('storage/' . $menuItem->image_url) }}" alt="{{ $menuItem->name }}" class="mt-1 h-32 w-auto object-cover rounded">
                        </div>
                        @endif

                        <!-- New Image (Optional) -->
                        <div class="mt-4">
                            <x-input-label for="image_url" :value="__('Change Item Image (Optional)')" />
                        ...
                        <div class="block mt-4">
                            <label for="is_available" class="inline-flex items-center">
                                <input id="is_available" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="is_available" value="1" {{ old('is_available', $menuItem->is_available) ? 'checked' : '' }}>
